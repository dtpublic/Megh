 ...
 * Users of this schema are concrete classes of
 * {@link AbstractDelimitedProcessorOperator} The operators use this information
 * to validate the incoming tuples. Information from JSON schema is saved in
 * this object and is used by the operators
 * <p>
 * <br>
 * <br>
 * Example schema <br>
