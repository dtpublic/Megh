 ...
 * @param <T>
 */
public class HDFSLogReader<T> implements LogReader<T>
{
  DataInputStream in;
  T entry = null;
  String name;
  ...
  public HDFSLogReader(HDHTFileAccess bfs, LogSerializer<T> serializer, long bucketKey, String name) throws IOException
  {
    this.name = name;
