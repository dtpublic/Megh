 ...
 * @param <T>
 */
public class HDFSLogWriter<T> implements LogWriter<T>
{
  ...
  public HDFSLogWriter(HDHTFileAccess bfs, LogSerializer<T> serializer, long bucketKey, String name) throws IOException
  {
