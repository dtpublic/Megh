...
public class CassandraQueryOutputOperatorTest
{
  ...
  {
    public TestPojo(UUID id, int age, String lastname, boolean test, float floatValue, double doubleValue,
        Set<Integer> set1, List<Integer> list1, Map<String, Integer> map1, Date date)
    {
      this.id = id;
      this.age = age;
