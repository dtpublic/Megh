...
public class WALTest
{
  ...
  public void testWalWriteAndRead() throws IOException
  {
    ...
    HDFSLogWriter wWriter = new HDFSLogWriter(bfs, new HDHTLogEntry.HDHTLogSerializer(), 1, "WAL-0");
    ...
    HDFSLogReader wReader = new HDFSLogReader(bfs, new HDHTLogEntry.HDHTLogSerializer(), 1, "WAL-0");
    int tuples = 0;
    int puts = 0;
    int purges = 0;
    int deletes = 0;
