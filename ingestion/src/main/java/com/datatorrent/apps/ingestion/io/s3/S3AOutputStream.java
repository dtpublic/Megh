...
import static com.datatorrent.apps.ingestion.io.s3.Constants.BUFFER_DIR;
...
public class S3AOutputStream extends OutputStream {
  ...
  private DTS3FileSystem fs;
  private CannedAccessControlList cannedACL;
  private FileSystem.Statistics statistics;
  private LocalDirAllocator lDirAlloc;
  private String serverSideEncryptionAlgorithm;

  public static final Logger LOG = DTS3FileSystem.LOG;

  public S3AOutputStream(Configuration conf, TransferManager transfers,
      DTS3FileSystem fs, String bucket, String key, Progressable progress,
