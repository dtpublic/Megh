...
public abstract class AbstractExpirableTimeBasedBucketManager<T> extends AbstractExpirableOrderedBucketManager<T>
{
  ...
  public void startService(Listener<T> listener)
  {
    ...
    logger.debug("bucket properties: Expiry Period {}, Bucket Span {}", expiryPeriod, bucketSpan);
    logger.debug("bucket time params: start {}, expiry point {}, end {}", startOfBuckets, expiryPoint, endOfBuckets);
