...
public class ExpirableTimeBasedBucketManagerPOJOImpl extends AbstractExpirableTimeBasedBucketManager<Object>
{
  ...
  protected long getTime(Object event)
  {
    if(getter==null)
    {
      ...
      GetterLong<Object> getterTime = PojoUtils.createGetterLong(fqcn, timeExpression);
      getter = getterTime;
    }
    return getter.get(event);
  }

  private static transient final Logger logger = LoggerFactory.getLogger(ExpirableTimeBasedBucketManagerPOJOImpl.class);
