 ...
 * @since 2.1.0
 */
public class ExpirableUnOrderedBucketManagerPOJOImpl extends AbstractExpirableUnorderedBucketManager<Object>
{
  @NotNull
  ...
  protected String getExpiryKey(Object event)
  {
    ...
    return getter.get(event).toString();
  }

  private static transient final Logger logger = LoggerFactory.getLogger(ExpirableUnOrderedBucketManagerPOJOImpl.class);
