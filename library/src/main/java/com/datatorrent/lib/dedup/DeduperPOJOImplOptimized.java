 ...
 * @since 2.1.0
 */
public class DeduperPOJOImplOptimized extends AbstractDeduperOptimized<Object, Object>
{
  ...
  private static transient final Logger logger = LoggerFactory.getLogger(DeduperPOJOImplOptimized.class);
