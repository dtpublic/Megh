...
public class DeduperTimeBasedPOJOImpl extends AbstractDeduperOptimized<Object, Object>
{
  ...
  public void processTuple(Object event)
  {
    if (getter==null) {
      ...
      getter = PojoUtils.createGetter(fqcn, ((ExpirableTimeBasedBucketManagerPOJOImpl) bucketManager).getKeyExpression(), Object.class);
    }
  ...
  private static transient final Logger logger = LoggerFactory.getLogger(DeduperTimeBasedPOJOImpl.class);
