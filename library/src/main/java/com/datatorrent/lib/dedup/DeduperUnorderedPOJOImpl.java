...
import com.datatorrent.lib.bucket.ExpirableUnOrderedBucketManagerPOJOImpl;
 ...
 * @since 2.1.0
 */
public class DeduperUnorderedPOJOImpl extends AbstractDeduperOptimized<Object, Object>
{
  ...
  public void processTuple(Object event)
  {
    if (getter==null) {
      ...
      getter = PojoUtils.createGetter(fqcn, ((ExpirableUnOrderedBucketManagerPOJOImpl) bucketManager).getKeyExpression(), Object.class);
    }
  ...
  private static transient final Logger logger = LoggerFactory.getLogger(DeduperUnorderedPOJOImpl.class);
