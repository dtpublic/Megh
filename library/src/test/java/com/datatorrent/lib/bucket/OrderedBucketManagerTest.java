...
public class OrderedBucketManagerTest
{
  ...
  private static class TestBucketManager<T extends Expirable & Bucketable> extends ExpirableOrderedBucketManagerImpl<T>
  {
    TestBucketManager()
    {
      super();
  ...
  // Tests both AbstractExpirableOrderedBucketManager and AbstractExpirableTimeBasedBucketManager
  @Test
  ...
  {
    AbstractExpirableOrderedBucketManager<DummyEvent> clonedManager = manager.clone();
