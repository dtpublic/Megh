...
import com.datatorrent.lib.bucket.ExpirableOrderedBucketManagerImpl;
...
public class DedupUsingOrderedExpiryTest
{
  ...
  private final static String APPLICATION_PATH_PREFIX = "target/DedupUsingOrderedExpiryTest";
  private final static String APP_ID = "DedupUsingOrderedExpiryTest";
  private final static int OPERATOR_ID = 0;

  private final static Exchanger<Long> eventBucketExchanger = new Exchanger<Long>();

  private static class DummyDeduper extends DeduperWithExpirableHdfsStore<DummyEvent, DummyEvent>
  {
  ...
  public void testDedup()
  {
    ...
    TestUtils.setSink(deduper.duplicate, collectorTestSinkDup);
  ...
  public static void setup()
  {
    ...
    ExpirableOrderedBucketManagerImpl<DummyEvent> storageManager = new ExpirableOrderedBucketManagerImpl<DummyEvent>();
