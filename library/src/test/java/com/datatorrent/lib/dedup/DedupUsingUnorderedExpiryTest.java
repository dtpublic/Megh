...
import com.datatorrent.lib.bucket.AbstractExpirableUnorderedBucketManager.EvictionPolicy;
...
public class DedupUsingUnorderedExpiryTest
{
  ...
  private static class DummyDeduper extends AbstractDeduperForExpirableEvents<TestEvent, TestEvent>
  {
  ...
  public static void setup()
  {
    ...
    storageManager.setNoOfBuckets(5);
    storageManager.setPolicy(EvictionPolicy.LRU);
