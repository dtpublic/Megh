...
import com.datatorrent.lib.bucket.ExpirableUnorderedBucketManagerImpl;
...
public class DedupUsingUnorderedExpiryTest
{
  ...
  private static class DummyDeduper extends DeduperWithExpirableHdfsStore<TestEvent, TestEvent>
  {
  ...
  public static void setup()
  {
    ...
    ExpirableUnorderedBucketManagerImpl<TestEvent> storageManager = new ExpirableUnorderedBucketManagerImpl<TestEvent>();
