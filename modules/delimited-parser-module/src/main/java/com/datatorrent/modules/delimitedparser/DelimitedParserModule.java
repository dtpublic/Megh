...
import com.datatorrent.contrib.delimited.DelimitedParserOperator;
 ...
 * 
 * Output Ports {@link #validatedData} - input tuples found valid against the
 * schema emitted as byte[] {@link #parsedData} - input tuples found valid
 * against the schema emitted as Map<String,Object> {@link #error} - invalid
 * input tuples emitted as KeyValPair<String, String> . Key is the tuple, Value
...
public class DelimitedParserModule implements Module
{
  ...
  /**
   * {@link #validatedData} input tuples found valid against the schema emitted
   * as byte[]
   */
  public final transient ProxyOutputPort<byte[]> validatedData = new ProxyOutputPort<byte[]>();
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    validatedData.set(delimitedParserOperator.validatedData);
