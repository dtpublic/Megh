 ...
 * @author Yogi/Sandeep
 */
public class ApplicationTestS3Output
{
  public static class TestMeta extends TestWatcher
  {
    ...
    protected void starting(org.junit.runner.Description description)
    {
      ...
      this.outputDirectory = "s3n://AKIAIUUYNR43F76GOFHA:cYKXtma2Lmfb3eQck0gD3ZjJ7ZJt0kYIYs4KoVN@ingestion.datatorrent.com/output/";
    }
  ...
  public void testApplication() throws Exception
  {
    ...
    System.out.println("Outputdir is: " + outDir);
