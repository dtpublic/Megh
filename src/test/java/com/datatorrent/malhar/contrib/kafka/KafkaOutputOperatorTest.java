 ...
 *
 */
public class KafkaOutputOperatorTest extends com.datatorrent.contrib.kafka.KafkaOperatorTestBase
{
      ...
      dataGeneratorThread = new Thread("String Generator")
      {
        ...
        public void run()
        {
          try {
            ...
            stringBuffer.put(com.datatorrent.contrib.kafka.KafkaOperatorTestBase.END_TUPLE);
          }
